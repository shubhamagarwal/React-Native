...
<KeyboardAwareScrollView>
            <View>
                ...
                <View style={{
                    ...
                    <Text style={{ color: '#183650', fontSize: 20, fontWeight: '600' }}>Terms and Conditions</Text>
                </View>
...
whether personally or on behalf of an entity (“you”) and Flake Technologies (“we,” “us” or “our”),
concerning your access to and use of the Flake, a mobile application as well as any other media
form, media channel, or mobile website related, linked, or otherwise connected thereto
(collectively, the “App”). You agree that by accessing the App, you have read, understood, and
...
accepted, the changes in any revised Terms and Conditions by your continued use of the App
...
Canada, foreign jurisdictions, and international conventions. The Content and the Marks are
provided on the App “AS IS” for your information and personal use only. Except as expressly
provided in these Terms of Use, no part of the App and no Content or Marks may be copied,
reproduced, aggregated, republished, uploaded, encoded, translated, transmitted, distributed,
...
expressly granted to you in and to the App, Content and the Marks.
</Text>  
<Text style={{ color: '#183650', fontSize: 18, fontWeight: 'bold', padding: '2%' }}>
...
and you agree to comply with these Terms of Use; [(4) you are not under the age of 13;] (5) not
a minor in the jurisdiction in which you reside[, or if a minor, you have received parental
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
You are required to register with the App. You agree to keep your password confidential and will
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
1. systematically retrieve data or other content from the App to create or compile, directly
or indirectly, a collection, compilation, database, or directory without written permission
from us.
</Text>   
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
2. make any unauthorized use of the App, including collecting usernames and/or email
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
5. circumvent, disable, or otherwise interfere with security-related features of the App,
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
10. interfere with, disrupt, or create an undue burden on the App or the networks or services
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
13. use any information obtained from the App in order to harass, abuse, or harm another
person.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
14. use the App as part of any effort to compete with us or otherwise use the App and/or the
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
16. attempt to bypass any measures of the App designed to prevent or restrict access to the
App, or any portion of the App.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
17. harass, annoy, intimidate, or threaten any of our employees or agents engaged in
providing any portion of the App to you.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
18. delete the copyright or other proprietary rights notice from any Content.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
19. copy or adapt the App’s software, including but not limited to PHP, HTML, JavaScript, or
other code.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
...
App or modifies, impairs, disrupts, alters, or interferes with the use, features, functions,
...
spider, robot, cheat utility, scraper, or offline reader that accesses the App, or using or
...
on the App, including but not limited to text, writings, video, audio, photographs, graphics,
comments, suggestions, or personal information or other material (collectively, &quot;Contributions&quot;).
Contributions may be viewable by other users of the App and through third-party webApps. As
...
releases, and permissions to use and to authorize us, the App, and other users of the
App to use your Contributions in any manner contemplated by the App and these Terms
of Use.
</Text>  
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
Any use of the App in violation of the foregoing violates these Terms of Use and may result in,
...
App by linking your account from the App to any of your social networking accounts], you
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
If you access the App via a mobile application, then we grant you a revocable, non-exclusive,
...
webApp or to send any unsolicited commercial e-mail; or (9) use any proprietary information or
...
Store or Google Play (each an “App Distributor”) to access the App: (1) the license granted to
...
not located in a country that is subject to a Canadian government embargo, or that has been
designated by the Canadian government as a “terrorist supporting” country and (ii) you are not
listed on any Canadian government list of prohibited or restricted parties; (5) you must comply
with applicable third-party terms of agreement when using the mobile application, e.g., if you
...
your account on the App and your Third-Party Accounts at any time. PLEASE NOTE THAT
...
App. You can deactivate the connection between the App and your Third-Party Account by
...
Third-Party Websitess or to use or install any Third-Party Content, you do so at your own risk,
...
the App, such as native advertisements or banner advertisements. If you are an advertiser, you
shall take full responsibility for any advertisements you place on the App and any services
provided on the App or products sold through those advertisements. Further, as an advertiser,
you warrant and represent that you possess all rights and authority to place advertisements on
the App, including, but not limited to, intellectual property rights, publicity rights, and contractual
...
understand and agree there will be no refund or other compensation for DMCA takedown-
related issues.] We simply provide the space to place such advertisements, and we have no
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
We care about data privacy and security. Please review our Privacy Policy [CLICK HERE]. By
using the App, you agree to be bound by our Privacy Policy, which is incorporated into these
Terms of Use. Please be advised the App is hosted in Canada. If you access the App from the
United States, European Union, Asia, or any other region of the world with laws or other
requirements governing personal data collection, use, or disclosure that differ from applicable
laws in the Canada, then through your continued use of the App or Services, you are

transferring your data to Canada, and you expressly consent to have your data transferred to
and processed in Canada. [Further, we do not knowingly accept, request, or solicit information
...
will delete that information from the App as quickly as is reasonably practical.
</Text> 
<Text style={{ color: '#183650', fontSize: 18, fontWeight: 'bold', padding: '2%' }}>
...
or through the App infringes upon any copyright you own or control, please immediately notify
...
sure that material located on or linked to by the App infringes your copyright, you should
...
copyrighted work claimed to have been infringed, or, if multiple copyrighted works on the App
are covered by the Notification, a representative list of such works on the App; (3) identification
...
is accurate, and under penalty of perjury, that the complaining party is authorized to act on
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
If you believe your own copyrighted material has been removed from the App as a result of a
mistake or misidentification, you may submit a written counter notification to [us/our Designated
Copyright Agent] using the contact information provided below (a “Counter Notification”). To be
an effective Counter Notification under the DMCA, your Counter Notification must include
substantially the following: (1) identification of the material that has been removed or disabled
and the location at which the material appeared before it was removed or disabled; (2) a
statement that you consent to the jurisdiction of the Federal District Court in which your address
is located, or if your address is outside the United States, for any judicial district in which we are
located; (3) a statement that you will accept service of process from the party that filed the
...
to by the App infringes your copyright, you should consider first contacting an attorney.]
</Text> 
<Text style={{ color: '#183650', fontSize: 18, fontWeight: 'bold', padding: '2%' }}>
...
TERMINATE YOUR USE OR PARTICIPATION IN THE APP OR DELETE [YOUR ACCOUNT
...
with the laws of Ontario applicable to agreements made and to be entirely performed within the
Province/Commonwealth of Ontario, without regard to its conflict of law principles.
</Text> 
<Text style={{ color: '#183650', fontSize: 18, fontWeight: 'bold', padding: '2%' }}>
DISPUTE RESOLUTION
</Text> 
...
“Parties” and individually, a “Party”) shall be commenced or prosecuted in the provincial and
federal courts located in Ontario, Canada, and the Parties hereby consent to, and waive all
defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and
jurisdiction in such provincial and federal courts. Application of the United Nations Convention
...
action, or proceeding brought by either Party related in any way to the app be commenced more
than 2 years after the cause of action arose.
</Text> 
<Text style={{ color: '#183650', fontSize: 18, fontWeight: 'bold', padding: '2%' }}>
...
webApp www.adr.org. Your arbitration fees and your share of arbitrator compensation shall be
governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer
Rules. [If such costs are determined to by the arbitrator to be excessive, we will pay all
...
place in [name of county] County, [name of state]. Except as otherwise provided herein, the
...
commenced or prosecuted in the state and federal courts located in Ontario, Canada, and the
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
In no event shall any Dispute brought by either Party related in any way to the App be
...
AAA webApp www.adr.org. Your arbitration fees and your share of arbitrator compensation shall
be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA
Consumer Rules. [If such costs are determined to by the arbitrator to be excessive, we will pay
all arbitration fees and expenses.] The arbitration may be conducted in person, through the
submission of documents, by phone, or online. The arbitrator will make a decision in writing, but
need not provide a statement of reasons unless requested by either Party. The arbitrator must
follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except
where otherwise required by the applicable AAA rules or applicable law, the arbitration will take
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be
commenced or prosecuted in the state and federal courts located in [name of county] County,
[name of state], and the Parties hereby consent to, and waive all defenses of lack of, personal
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
In no event shall any Dispute brought by either Party related in any way to the App or Services
be commenced more than 2 years after the cause of action arose. If this provision is found to be
illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that
portion of this provision found to be illegal or unenforceable and such Dispute shall be decided
by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties
agree to submit to the personal jurisdiction of that court.
...
omissions that may relate to the App, including descriptions, pricing, availability, and various
...
YOUR USE OF THE APP SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST
...
CONTENT OR THE CONTENT OF ANY WEBAppS LINKED TO THIS APP AND WE WILL
...
THROUGH THE APP, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE
...
AMOUNT PAID, IF ANY, BY YOU TO US DURING THE [6] MONTH PERIOD PRIOR TO ANY
CAUSE OF ACTION ARISING. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
We will maintain certain data that you transmit to the App for the purpose of managing the App,
as well as data relating to your use of the App. Although we perform regular routine backups of
data, you are solely responsible for all data that you transmit or that relates to any activity you
have undertaken using the App. You agree that we shall have no liability to you for any loss or
corruption of any such data, and you hereby waive any right of action against us arising from
...
<Text style={{ color: '#183650', fontSize: 16, fontWeight: '300', padding: '2%' }}>
These Terms of Use and any policies or operating rules posted by us on the App constitute the
...
result of these Terms of Use or use of the App. You agree that these Terms of Use will not be
